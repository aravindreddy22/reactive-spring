package com.learning.reactivespring.reactivespring.controller.v1;
...
public class ItemControllerTest {
    ...
    public void getAllItemsTest_approach2() {
        webTestClient.get().uri("/v1/items")
                ...
                .consumeWith(response -> {
                    final List<Item> responseBody = response.getResponseBody();
    ...
    public void getAllItemsTest_approach3() {
        Flux<Item> responseBody = webTestClient.get().uri("/v1/items")
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(MediaType.APPLICATION_JSON)
